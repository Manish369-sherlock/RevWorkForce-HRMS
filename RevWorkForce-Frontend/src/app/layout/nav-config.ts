        ...
        case Role.ADMIN:
            return [
                ...
                },
                {
                    title: 'Finance & AI',
                    items:[
                        {label: 'Expenses', route: '/admin/expenses', iconPaths: ICONS['receipt']},
                        {label: 'AI Reports', route: '/admin/ai-reports', iconPaths: ICONS['report']},
                    ]
                },
                {
            ...
            return [
                ...
                },
                {
                    ...
                    items: [
                        ...
                        {
                            label: 'Team Expenses', route: '/manager/team-expenses', iconPaths: ICONS['receipt']
                        }
                    ]
                },
                {
        ...
        case Role.EMPLOYEE:
            return [
                ...
                },
                {
                    ...
                    items: [
                        {
                            label: 'My Expenses', route: '/employee/my-expenses', iconPaths: ICONS['receipt']
                        }
                    ]
                },
                {
