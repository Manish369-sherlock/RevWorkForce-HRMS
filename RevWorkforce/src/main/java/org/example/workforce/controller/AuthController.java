...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse> login(
        ...
        if (employee.getRole() != Role.ADMIN &&
                !ipAccessControlService.isIpAllowed(ipAddress)) {
            ...
            throw new IpBlockedException(
                    "Access denied. Your IP address (" + ipAddress +
                            ") is not whitelisted. Please contact your administrator."
            );
        }

        /*
         * OTP/2FA is intentionally bypassed during normal login.
         * Email/password authentication now goes directly to JWT login.
         */
    ...
    public ResponseEntity<ApiResponse> verifyOtp(
        ...
        Employee employee = otpService.verifyOtp(
                request.getPreAuthToken(),
                request.getOtp()
        );

        UserDetails userDetails =
                userDetailsService.loadUserByUsername(employee.getEmail());
    ...
    public ResponseEntity<ApiResponse> resendOtp(
        ...
        String newPreAuthToken =
                otpService.resendOtp(request.getPreAuthToken());
    ...
    public ResponseEntity<ApiResponse> refreshToken(
        ...
        String newAccessToken =
                jwtUtil.generateToken(extraClaims, userDetails);
    ...
    public ResponseEntity<ApiResponse> logout(
        ...
        if (auth != null &&
            ...
            if (employee != null) {
                ...
                activityLogRepository.save(ActivityLog.builder()
                        ...
                        .ipAddress(
                                NetworkIpUtil.resolveClientIp(httpRequest)
                        )
                        .status("SUCCESS")
                        .build());
            }
        ...
        return ResponseEntity.ok(
                new ApiResponse(
                        true,
                        "Logged out successfully. All refresh tokens revoked."
                )
        );
    }

    private ResponseEntity<ApiResponse> buildLoginResponse(
            Employee employee,
            UserDetails userDetails,
            String ipAddress,
            String userAgent) {
